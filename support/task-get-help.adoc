...
summary: 'NetApp ofrece soporte para la Console de diversas formas. Hay disponibles numerosas opciones gratuitas de autoayuda las 24x7, como artículos de la knowledgebase (KB) y un foro de la comunidad. Tu registro de soporte incluye soporte técnico remoto a través de tickets web.' 
---
= Obtener ayuda
:allow-uri-read: 
:icons: font
